...
param_in = [200,0.01,0,60,20,0,0,0.0254804,0.04,270];
param_mod = [0.9597 0.1908 0.0167 0.1002 0.579 12.5596 66.5337 100];

F_in = 2;

F_0 = [0.25 0 0 0.025 0.025];
tspan = linspace(0,20000,150);

%% Optimización
lb = [50, 0, 0];    % [I0, R, F_in]
ub = [500, 5, 5];

p0 = [param_in(1), param_in(2), F_in];
...
function F = modelo_ode(t,Y,max,min,param_in,param_mod,F_in)
