clc; clear; close all
%% Parametros
max = [0.0418 0.2109 0.6995 0.1197 0.0762]; % max
min = [0.0196 0.0006]; % min

param_in = [200,0.15,0,60,20,0,0,0.0254804,0.04,270]; % Entrada
param_mod = [0.9597 0.1908 0.0167 0.1002 0.579 12.5596 66.5337 100]; % Modelo
